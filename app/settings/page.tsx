    ...
    <section className="px-6 py-12 max-w-2xl mx-auto">
      ...
      <div className="mt-12 border border-ink p-6">
        ...
        <div className="mt-5 flex items-center justify-between gap-4 flex-wrap">
          <p className="font-mono text-[11px] tracking-[0.15em] text-muted leading-relaxed max-w-md">
      ...
      <div className="mt-10">
        ...
        <p className="font-mono text-[11px] tracking-[0.2em] text-muted mt-4 leading-relaxed">
      ...
      <div className="mt-10">
        ...
        <pre className="mt-4 font-mono text-xs leading-relaxed bg-paper border border-line p-4 overflow-x-auto">
{`# 문장 보내기
